module.exports = [
    ...
    ['home-beta',                          'static/home',                               'full_width', 'Online Trading platform for binary options on Forex, Indices, Commodities and Smart Indices', 'ja'],
    ['home',                               'static/home_old',                           'full_width', 'Online Trading platform for binary options on Forex, Indices, Commodities and Smart Indices', 'ja'],
    ...
    ['get-started',                        'static/get_started_old/index',                  'get_started', 'Get Started',                      'ja'],
    ['get-started/beginners-faq',          'static/get_started_old/beginners_faq',          'get_started', 'FAQ',                              'ja'],
    ['get-started/binary-options-basics',  'static/get_started_old/binary_options_basics',  'get_started', 'Binary Options Basics',            'ja'],
    ['get-started/glossary',               'static/get_started_old/glossary',               'get_started', 'Glossary',                         'ja'],
    ['get-started/how-to-trade-binaries',  'static/get_started_old/how_to_trade_binaries',  'get_started', 'How to Trade Binary Options?',     'ja'],
    ['get-started/otc-indices-stocks',     'static/get_started_old/otc_indices_stocks',     'get_started', 'What Are OTC Indices and Stocks?', 'ja'],
    ['get-started/smart-indices',          'static/get_started_old/smart_indices',          'get_started', 'Smart Indices',                    'ja'],
    ['get-started/types-of-trades',        'static/get_started_old/types_of_trades',        'get_started', 'Types of Trades',                  'ja'],
    ['get-started/volidx-markets',         'static/get_started_old/volidx_markets',         'get_started', 'Volatility Index Markets',         'ja'],
    ['get-started/what-is-binary-trading', 'static/get_started_old/what_is_binary_trading', 'get_started', 'Why Choose Binary Trading?',       'ja'],
    ['get-started/why-trade-with-us',      'static/get_started_old/why_trade_with_us',      'get_started', 'Why Trade with Binary.com',        'ja'],

    ['get-started-beta',                        'static/get_started/index',                  'default',     'Get Started',                      'ja'],
    ['get-started-beta/binary-options',         'static/get_started/binary_options',         'default',     'Binary Options',                   'ja'],
    ['get-started-beta/cfds',                   'static/get_started/cfds',                   'default',     'CFDs',                             'ja'],
    ['get-started-beta/cryptocurrencies',       'static/get_started/cryptocurrencies',       'default',     'Cryptocurrencies',                 'ja'],
    ['get-started-beta/forex',                  'static/get_started/forex',                  'default',     'Forex',                            'ja'],
    ['get-started-beta/metals',                 'static/get_started/metals',                 'default',     'Metals',                           'ja'],
